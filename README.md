...
**Γιατί χωριστά:** το περιεχόμενο (Ανακοινώσεις, Μεταπτυχιακά, Εκδηλώσεις,
Προσωπικό, Έγγραφα) και τα πεδία του ανήκουν στο πρόσθετο, οπότε επιβιώνουν σε αλλαγή θέματος.
...
- Δοκιμαστικό περιεχόμενο αντλημένο από τον ιστότοπο της **Κοσμητείας της Σχολής
  Επιστημών Υγείας Δ.Π.Θ.** ([health.duth.gr](https://health.duth.gr/)): **3 κάρτες
  Τμημάτων** στην αρχική (Ιατρικής, Μοριακής Βιολογίας & Γενετικής, Νοσηλευτικής),
  **μήνυμα Κοσμήτορα**, **6 Ανακοινώσεις**,
...
δικές του** ανακοινώσεις και να ανεβάζει τα συνημμένα τους. Δεν βλέπει
...
- Αρχική, αρχεία και μεμονωμένες σελίδες Ανακοινώσεων / Μεταπτυχιακών:
